...
let mkXt_with_trend_64 [N] (k2p2: i64) (f: f32) (mappingindices: [N]i32): [N][k2p2]f64 =
  map (\ind ->
        map (\i ->
                if i == 0 then 1f64
                else if i == 1 then r64 ind
                else let (i', j') = (r64 (i / 2), r64 ind)
...
let mkXt_no_trend_64 [N] (k2p2m1: i64) (f: f32) (mappingindices: [N]i32): [N][k2p2m1]f64 =
  map (\ ind ->
        map (\i ->
                if i == 0 then 1f64
                else let i = i + 1
